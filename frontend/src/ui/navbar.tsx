    ...
    return (
        <>
            ...
            <div className="overflow-hidden">
                <div className="max-w-[85rem] mx-auto px-3 sm:px-6 lg:px-8 py-8 sm:py-10 lg:py-20">
                    <div className="relative mx-auto max-w-8xl lg:px-40 grid space-y-2 sm:space-y-6">
                        <div className="text-center">
                            ...
                            <h1 className="text-3xl text-gray-800 font-bold sm:text-5xl lg:text-6xl lg:leading-[4rem] dark:text-neutral-200">
                                Your{" "}
                                <span className="bg-clip-text bg-gradient-to-l text-transparent from-green-500 to-emerald-500">
                                    agile tool
                                </span>{" "}
                        ...
                        <div className="relative overflow-hidden">
                            <div className="mx-auto px-4 sm:px-6 lg:px-8 py-5">
                                <div className="mt-2 md:mt-0 relative max-w-5xl mx-auto">
                                    <div className="w-full object-cover h-96 sm:h-[480px] bg-[url('https://cdn.prod.website-files.com/64fb9a53773061d47cec7f77/675f53c44dda86da19721978_Group%203639%20(1)-p-800.png')] bg-no-repeat bg-center bg-cover rounded-xl"></div>

                                    <div className="absolute bottom-12 -start-20 -z-[1] size-48 p-px rounded-lg dark:to-neutral-900">
                                        <div className="bg-gradient-to-b from-emerald-300 to-green-500 size-48 rounded-lg dark:bg-neutral-900"></div>
                                    </div>

                                    <div className="absolute -top-12 -end-20 -z-[1] size-48 p-px rounded-full">
                                        <div className="bg-gradient-to-t from-emerald-300 to-green-500 size-48 rounded-full dark:bg-neutral-900"></div>
                                    </div>
                                </div>
                            </div>
                        </div>

                        <div className="mt-6 md:mt-12 py-3 px-4 inline-flex items-center text-lg text-gray-800 gap-x-1.5 after:flex-1 after:border-t after:border-gray-200 after:ms-6 dark:text-white dark:after:border-neutral-700">
                            <span className="font-extrabold bg-clip-text bg-gradient-to-l from-green-500 to-emerald-500 text-transparent dark:from-blue-400 dark:to-violet-400">
                                50,000
                            </span>
                            individuals trust Fragro
                        </div>

                        <div className="flex flex-wrap justify-between gap-x-6 sm:gap-x-12 lg:gap-x-24 px-4">
                            <svg
                        ...
                        <div className="hidden xl:block absolute top-0 end-0 -translate-y-20 xl:-translate-x-[52rem] -rotate-45">
                            <svg
